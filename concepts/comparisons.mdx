...
description: "Side-by-side comparison of ProofBridge against Hashport, Wormhole, Stargate, and LayerZero across custody, validation, and settlement."
---
...
| Feature | ProofBridge | Hashport | Wormhole / Stargate / LayerZero |
|---|:---:|:---:|:---:|
...
Hashport, Wormhole, Stargate, and LayerZero all route transfers through an external validator set (guardians, relayers, or oracles) that must sign off before funds move. Those validators are a trust assumption and a target.
